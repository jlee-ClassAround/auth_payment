      ...
      <form onSubmit={onSearch}>
        <input
          ...
          className={cn(
            ...
            "outline-none text-[15px] font-light bg-foreground/10 rounded-lg transition-colors ring-1 ring-transparent focus:ring-primary/50",
            "hover:ring-primary/60 transition"
          )}
        />
        <button type="submit">
